    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-secondary-400 mt-1 font-sans">Create a new lab test or miscellaneous bill</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm shadow-gray-100 border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-secondary-800">Lab Tests / Services</h2>
              ...
              <div key={index} className="flex gap-2 items-start">
                <div className="flex-1 space-y-2">
                  ...
                  >
                    ...
                    {services.filter(s => s.category === 'laboratory' || s.category === 'radiology').map(svc => (
        ...
        <div className="flex gap-3">
          ...
          <button
            type="submit"
            disabled={saving}
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl hover:from-purple-600 hover:to-purple-700 transition-all shadow-md shadow-purple-500/20 font-sans font-semibold disabled:opacity-50"
          >
